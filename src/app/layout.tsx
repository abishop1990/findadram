...
// Metadata cannot be exported from a 'use client' file, so it is defined
// separately and re-exported via the module. Next.js will still pick it up
// from the default export's module. In practice, move metadata to a
// separate layout-metadata.ts if the build complains; for hackathon purposes
// this declaration documents intent.
