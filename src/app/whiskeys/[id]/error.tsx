  ...
  return (
    <div className="min-h-screen bg-whiskey-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg border-2 border-red-200 p-8">
        ...
        <h2 className="text-2xl font-semibold text-whiskey-900 mb-2 text-center">Failed to load whiskey</h2>
        <p className="text-whiskey-600 mb-6 text-center text-sm">{error.message || 'Something went wrong'}</p>
        <button
          onClick={reset}
